...
public final class Transmit: ObservableObject {
  ...
  @Published public internal(set) var carrierLevel = 0
  @Published public internal(set) var companderEnabled = false
  @Published public internal(set) var companderLevel = 0
  @Published public internal(set) var cwBreakInDelay = 0
  @Published public internal(set) var cwBreakInEnabled = false
  @Published public internal(set) var cwIambicEnabled = false
  @Published public internal(set) var cwIambicMode = 0
  @Published public internal(set) var cwlEnabled = false
  @Published public internal(set) var cwPitch = 0
  @Published public internal(set) var cwSidetoneEnabled = false
  @Published public internal(set) var cwSpeed = 0
  @Published public internal(set) var cwSwapPaddles = false
  @Published public internal(set) var cwSyncCwxEnabled = false
  @Published public internal(set) var daxEnabled = false
  ...
  @Published public internal(set) var maxPowerLevel = 0
  @Published public internal(set) var metInRxEnabled = false
  @Published public internal(set) var micAccEnabled = false
  @Published public internal(set) var micBiasEnabled = false
  @Published public internal(set) var micBoostEnabled = false
  @Published public internal(set) var micLevel = 0
  @Published public internal(set) var micSelection = ""
  @Published public internal(set) var rawIqEnabled = false
  @Published public internal(set) var rfPower = 0
  @Published public internal(set) var speechProcessorEnabled = false
  @Published public internal(set) var speechProcessorLevel = 0
  @Published public internal(set) var tune = false
  @Published public internal(set) var tunePower = 0
  @Published public internal(set) var txAntenna = ""
  @Published public internal(set) var txFilterChanges = false
  @Published public internal(set) var txFilterHigh = 0
  @Published public internal(set) var txFilterLow = 0
  @Published public internal(set) var txInWaterfallEnabled = false
  @Published public internal(set) var txMonitorAvailable = false
  @Published public internal(set) var txMonitorEnabled = false
  @Published public internal(set) var txMonitorGainCw = 0
  @Published public internal(set) var txMonitorGainSb = 0
  @Published public internal(set) var txMonitorPanCw = 0
  @Published public internal(set) var txMonitorPanSb = 0
  @Published public internal(set) var txRfPowerChanges = false
  @Published public internal(set) var txSliceMode = ""
  @Published public internal(set) var voxEnabled = false
  @Published public internal(set) var voxDelay = 0
  @Published public internal(set) var voxLevel = 0
